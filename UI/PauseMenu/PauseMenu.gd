...
onready var pages_image			= $MarginContainer/MarginContainer/BookContainer/HBoxContainer/Pages

onready var left_arrow_button 	= $MarginContainer/MarginContainer/BookContainer/HBoxContainer/LeftArrow
onready var right_arrow_button  = $MarginContainer/MarginContainer/BookContainer/HBoxContainer/RightArrow
