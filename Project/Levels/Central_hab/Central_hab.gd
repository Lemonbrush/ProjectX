...
onready var witch = $Middle_world_objects/Dwellers/CookerDweller
...
func _ready():
	...
	var _witch_lower_volume_connection = witch.connect("set_background_music_volume", self, "set_background_music_volumeDB")
	var _witch_reset_volume_connection = witch.connect("reset_background_music_volume", self, "reset_background_music_volumeDB")
